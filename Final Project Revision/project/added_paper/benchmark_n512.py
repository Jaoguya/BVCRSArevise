#!/usr/bin/env python3
"""
Benchmark with Lattice Parameter n = 512
=========================================
Runs AC-SCRAT + ABSE-Range + IBE-Lattice with IBE lattice dimension n=512.
Uses REAL crypto + REAL MongoDB Atlas.

Outputs:
  n512_bench_dim1_vs_N.csv
  n512_bench_dim2_vs_range.csv
  n512_bench_dim3_vs_keywords.csv
"""
...
# ══════════════════════════════════════════════════════════════════════
#  OVERRIDE LATTICE PARAMETER: n = 512
# ══════════════════════════════════════════════════════════════════════
LATTICE_N = 512
LATTICE_M = LATTICE_N * 4   # m = 4n = 2048
LATTICE_Q = 4093
ib_mod.lat = ib_mod.LatticeLib(n=LATTICE_N, m=LATTICE_M, q=LATTICE_Q)
print(f"  ★ IBE-Lattice configured: n={LATTICE_N}, m={LATTICE_M}, q={LATTICE_Q}")
...
def main():
    print("\n╔══════════════════════════════════════════════════════════════════════╗")
    print(f"║  Benchmark — Lattice Parameter n = {LATTICE_N}  (m={LATTICE_M}, q={LATTICE_Q})          ║")
    ...
    save_csv("n512_bench_dim1_vs_N.csv", results_vs_n, "N")
    ...
    save_csv("n512_bench_dim2_vs_range.csv", results_vs_range, "range_pct")
    ...
    save_csv("n512_bench_dim3_vs_keywords.csv", results_vs_kw, "keywords")

    print(f"\n  ✓ All CSVs saved (prefix: n512_)")
    client.close()
    print(f"\n  ✅ Benchmark (n={LATTICE_N}) complete!")
