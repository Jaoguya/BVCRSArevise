#!/usr/bin/env python3
"""
Plot combined benchmark results — 6 algorithms
AC-SCRAT, ABSE-Range, IBE-Lattice, Trinity-I, Trinity-II, MHRQ
Reads: combined_dim1_vs_N.csv, combined_dim2_vs_range.csv, combined_dim3_vs_keywords.csv
Produces 7 IEEE-styled graphs.
"""
...
ALGOS = {
    ...
    "Trinity-I":   {"color": "#2980B9", "marker": "s", "ls": "-.", "lw": 2.2, "ms": 8},
    "Trinity-II":  {"color": "#27AE60", "marker": "D", "ls": "-.", "lw": 2.2, "ms": 7},
    "MHRQ":        {"color": "#F39C12", "marker": "^", "ls": ":",  "lw": 2.2, "ms": 8},
}
ALGO_ORDER = ["AC-SCRAT", "ABSE-Range", "IBE-Lattice", "Trinity-I", "Trinity-II", "MHRQ"]
...
def plot_graph(data, metric, xlabel, ylabel, title, filename, log_y=True):
    ...
    # Use x-ticks from the first algo that has data
    for algo in ALGO_ORDER:
        if data[algo]["x"]:
